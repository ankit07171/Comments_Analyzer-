...
ui_theme.py
------------
Centralized visual language for the dashboard: a dark, data-product aesthetic
(deep navy background, violet/teal accents, soft glass cards) plus small
component helpers so dashboard.py stays readable instead of drowning in
inline HTML.
"""
