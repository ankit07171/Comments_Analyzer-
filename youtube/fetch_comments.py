"""
youtube/fetch_comments.py
---------------------------
Fetches top-level comments for a YouTube video via the YouTube Data API,
capturing author, like count and timestamp so the analyzer can report
WHO said something and WHEN (for burst/priority detection) — not just
...
API_KEY = os.getenv("API_KEY") or os.getenv("YOUTUBE_API_KEY")
